        ...
        content: (
          <>
            ...
            <p className="mt-2 text-xs leading-relaxed text-fg-muted">
              Το slide 26 γράφει την ίδια έκφραση{' '}
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <p className="mt-2 text-xs leading-relaxed text-fg-muted">
              Το slide 46 δίνει αυτόν τον <em>ακριβή</em> αριθμό συνιστωσών{' '}
    ...
    entries: [
      {
        ...
        content: <BlockMath>{'\\sigma^2 = 4kTRW \\;\\Rightarrow\\; P_N = kTW = kTB \\quad,\\quad \\mathcal{S}_N(f) = kT/2,\\;\\;k = 1.38\\times 10^{-23}\\,\\text{J/K},\\;T_0 = 290\\,\\text{K},\\;N_0 = kT_0 \\approx -174\\,\\text{dBm/Hz}'}</BlockMath>,
      },
      {
        id: 'white-noise-psd',
