    ...
    solution: (
      <>
        ...
        <p className="mt-3 font-medium text-fg">
          Γιατί αυτή η σειρά — με μία ερώτηση: «πόσο χώρο θέλει το καθένα;»
        </p>
        <p>
          Η αιτιολόγηση δεν χρειάζεται τίποτα εξωτικό. Κάθε υπηρεσία χρειάζεται
          ένα ορισμένο <strong>εύρος ζώνης ανά κανάλι</strong>, και οι χαμηλές
          συχνότητες είναι <strong>στριμωγμένες</strong>: κάτω από τα 30 MHz
          υπάρχει συνολικά λιγότερος χώρος απ' όσο πιάνει <em>ένα</em>{' '}
          τηλεοπτικό κανάλι. Βάλ' τα σε σειρά και η κατάταξη βγαίνει μόνη της:
        </p>
        <ul className="ml-5 list-disc text-fg-muted">
          <li>
            <strong>Ραδιόφωνο — λίγος χώρος αρκεί.</strong> Ένα AM κανάλι
            χρειάζεται ~9 kHz, ένα FM ~200 kHz. Χωράει άνετα χαμηλά, όπου
            εξάλλου η διάδοση είναι καλύτερη: το σήμα κάμπτεται γύρω από
            εμπόδια και καλύπτει μια ολόκληρη πόλη από έναν πομπό.
          </li>
          <li>
            <strong>Τηλεόραση — δεκαπλάσιος και βάλε χώρος.</strong> Ένα
            αναλογικό τηλεοπτικό κανάλι θέλει 6–8 MHz (εικόνα{' '}
            <em>και</em> ήχος). Δεν χωράει εκεί κάτω — ούτε ένα, πόσο μάλλον
            δεκάδες. Αναγκαστικά ανεβαίνει στα VHF/UHF.
          </li>
          <li>
            <strong>Δορυφορικά — ακόμα περισσότερο.</strong> Ένας
            αναμεταδότης κουβαλάει πολλά κανάλια <em>μαζί</em>, οπότε
            χρειάζεται δεκάδες MHz. Μόνο στα GHz υπάρχει τέτοιος χώρος. Και
            μπόνους: ψηλή <InlineMath>f</InlineMath> σημαίνει μικρό{' '}
            <InlineMath>{'\\lambda = c/f'}</InlineMath>, άρα{' '}
            <strong>μικρή κεραία</strong> — κρίσιμο όταν την εκτοξεύεις σε
            τροχιά.
          </li>
        </ul>
        <p>
          <strong>Με μία πρόταση:</strong> ανεβαίνεις σε συχνότητα{' '}
          <em>επειδή αναγκάζεσαι</em>, όχι επειδή το προτιμάς — κάθε φορά που
          χρειάζεσαι περισσότερο bandwidth, πληρώνεις με χειρότερη διάδοση και
          ανάγκη για οπτική επαφή.
        </p>

        <div className="my-3 rounded-md border border-sky-500/30 bg-sky-500/5 px-3 py-2.5 text-sm">
          <strong className="text-fg">
            Για τους δορυφόρους υπάρχει κι ένας δεύτερος, πιο απόλυτος λόγος.
          </strong>{' '}
          <span className="text-fg-muted">
            Δεν είναι απλώς ότι δεν <em>χωράνε</em> χαμηλά — δεν{' '}
            <strong>μπορούν</strong> να είναι χαμηλά. Οι συχνότητες κάτω από
            περίπου 30 MHz <strong>ανακλώνται από την ιονόσφαιρα</strong> και
            γυρίζουν πίσω στη Γη· γι' αυτό ακριβώς τα βραχέα ταξιδεύουν
            ηπείρους, «αναπηδώντας» ανάμεσα στο έδαφος και την ιονόσφαιρα. Το
            ίδιο φαινόμενο που κάνει τα βραχέα χρήσιμα, κάνει τη δορυφορική
            ζεύξη <em>αδύνατη</em> εκεί: το σήμα δεν φτάνει ποτέ έξω από την
            ατμόσφαιρα. Πάνω από τα ~30 MHz η ιονόσφαιρα γίνεται διαφανής και ο
            δορυφόρος γίνεται προσβάσιμος. (Αυτό είναι επιπλέον πληροφορία, όχι
            ύλη του μαθήματος — αλλά είναι η καθαρή απάντηση στο «γιατί όχι
            χαμηλά;».)
          </span>
        </div>
      </>
