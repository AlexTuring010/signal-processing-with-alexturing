...
<SourceDoc sources={{ pdf: 'Εργαστήριο/Εργαστήριο 5-ΤΥΧΑΙΑ_ΣΗΜΑΤΑ.pdf' }} />

<Callout type="note" title="Γιατί δεν υπάρχει Lab 4;">
Στις διαφάνειες η αρίθμηση πάει από Lab 3 κατευθείαν στο Lab 5. Δεν είναι λάθος στη σελίδα — έτσι είναι η αρίθμηση των slides.
</Callout>
