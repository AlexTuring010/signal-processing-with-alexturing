...
export function SoseReturnBanner() {
  ...
  return (
    <div className="sticky top-14 z-30 -mx-4 mb-4 border-b border-rose-500/30 bg-rose-500/10 px-4 py-2 backdrop-blur print:hidden sm:-mx-6 sm:px-6 lg:-mx-0 lg:px-0">
