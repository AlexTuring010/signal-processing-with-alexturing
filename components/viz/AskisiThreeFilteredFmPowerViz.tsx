 ...
 *   P_u  = (8²/2) [J_0² + 2·(J_1² + J_2² + J_3² + J_4²)] (10) ≈ 9.51 W
 *   P_x  = A_c²/2 = 32 W (από την ταυτότητα Σ J_n² = 1)
 *
 *   Ποσοστό P_u / P_x ≈ 29.7%  (9.43 W / 29.5% με τις στρογγυλευμένες τιμές
 *   του πίνακα Bessel). Η λυμένη διαφάνεια γράφει 11.1072 W / 34.71%, που δεν
 *   αναπαράγεται από καμία από τις δύο — είναι λάθος της διαφάνειας.
 *
    ...
    <figure className="my-6 rounded-lg border border-border bg-bg-elevated p-4">
      ...
      {Math.abs(bw - 64) < 1 && (
        <div className="mt-3 rounded-md border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 text-xs">
          ...
          {' '}
          <span className="text-fg-subtle">
            (Η λυμένη άσκηση των διαφανειών γράφει 11.1072 W / 34.71%. Δεν
            αναπαράγεται: οι τιμές του πίνακα Bessel δίνουν 9.43 W και οι
            ακριβείς 9.51 W, οπότε η στρογγυλοποίηση δεν εξηγεί τη διαφορά —
            είναι αριθμητικό λάθος της διαφάνειας. Η μεθοδολογία, που είναι
            και το ζητούμενο της εξέτασης, μένει η ίδια.)
          </span>
        </div>
      )}
