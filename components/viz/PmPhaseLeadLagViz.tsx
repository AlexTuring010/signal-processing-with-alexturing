...
export function PmPhaseLeadLagViz() {
  ...
  return (
    <figure className="my-6 rounded-lg border border-border bg-bg-elevated p-4">
      ...
      <p className="mb-3 text-xs text-fg-muted">
        <strong>Τα κενά στη μπλε καμπύλη δεν είναι σφάλμα σχεδίασης.</strong> Στο
        τετραγωνικό message το <span className="font-mono">m(t)</span> πηδάει
        ακαριαία, άρα πηδάει ακαριαία και η φάση — και μαζί της η ίδια η
        κυματομορφή. Δεν περνάει από ενδιάμεσες τιμές, οπότε το σχήμα{' '}
        <strong>σηκώνει το μολύβι</strong> αντί να τραβήξει μια κατακόρυφη γραμμή
        που θα υπονοούσε ότι περνάει. Γύρνα στο <strong>Ημιτονοειδές</strong>{' '}
        message και τα κενά εξαφανίζονται: συνεχές{' '}
        <span className="font-mono">m</span> ⇒ συνεχής φάση ⇒ συνεχής
        κυματομορφή.
      </p>
